package year2020.month12.no146;
...
public class LruCache {
    ...
    public static void main(String[] args) {
        ...
        myLRUCache.put(1, 1); // 缓存是 {1=1}
        myLRUCache.put(2, 2); // 缓存是 {1=1, 2=2}
        System.out.println(myLRUCache.get(1));      //1
        myLRUCache.put(3, 3); // 该操作会使得关键字 2 作废，缓存是 {1=1, 3=3}
        System.out.println(myLRUCache.get(2));      //-1
        myLRUCache.put(4, 4); // 该操作会使得关键字 1 作废，缓存是 {4=4, 3=3}
        System.out.println(myLRUCache.get(1));      //-1
