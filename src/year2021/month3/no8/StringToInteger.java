...
public class StringToInteger {
    public static void main(String[] args) {
        ...
        String s7 = Integer.toString(Integer.MAX_VALUE);
        String s8 = Integer.toString(Integer.MIN_VALUE);
        String s9 = Integer.toString(Integer.MIN_VALUE + 1);
        String s10 = "  -0012a42";
...
class Automation {
    ...
    public void add(char c) {
        status = statusMap[status][getStatusCol(c)];
        switch (status) {
            case SIGN:
                if (c == '-') {
                    isNegative = true;
            ...
            case NUMBER:
                ...
                if (isNegative && ans - 1 > Integer.MAX_VALUE) {
    ...
    public int getAns() {
        return (int) (isNegative ? ans * -1 : ans);
    }
}
