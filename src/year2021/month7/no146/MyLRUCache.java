...
class LRUCache {
    ...
    public void put(int key, int value) {
        ...
        Node node = doubleLinkedList.addFirst(key, value);
        map.put(key, node);
    }
}
...
class DoubleLinkedList {
    ...
    private final Node head;  // store the latest element
