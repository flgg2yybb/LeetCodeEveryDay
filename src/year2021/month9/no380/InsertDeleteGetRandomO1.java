...
class RandomizedSet {
    ...
    public boolean remove(int val) {
        ...
        Integer origin = map.get(val);
        int lastEleIndex = list.size() - 1;
        map.put(list.get(lastEleIndex), origin);
        Collections.swap(list, origin, lastEleIndex);
        map.remove(val);
