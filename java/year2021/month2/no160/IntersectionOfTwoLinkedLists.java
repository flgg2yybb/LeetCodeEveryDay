package year2021.month2.no160;

public class IntersectionOfTwoLinkedLists {
    public static void main(String[] args) {
        ListNode node1 = new ListNode(8, new ListNode(4, new ListNode(5)));
        ListNode headA1 = new ListNode(4, new ListNode(1, node1));
        ListNode headB1 = new ListNode(5, new ListNode(0, new ListNode(1, node1)));

        ListNode node2 = new ListNode(2, new ListNode(4));
        ListNode headA2 = new ListNode(0, new ListNode(9, new ListNode(1, node2)));
        ListNode headB2 = new ListNode(3, node2);
    ...
    public static ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        int aLen = getLinkedListLength(headA);
        int bLen = getLinkedListLength(headB);
        if (aLen == 0 || bLen == 0) {
            return null;
        }
//        root1.len > root2.len
        ListNode root1 = aLen > bLen ? headA : headB;
        ListNode root2 = aLen > bLen ? headB : headA;
    ...
    private static int getLinkedListLength(ListNode linkedList) {
